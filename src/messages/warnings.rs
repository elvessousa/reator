...
pub const WARN_INVALID_RN_ONLY_STYLE: &str = "RN Styles available only to React Native Components.";
...
pub const WARN_API_STYLING: &str = "Styling an API Route is useless.";
